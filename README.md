...
<p align="justify"> 
Getting started with the project : The project consists in making a dog flap. The goal is to detect the presence of a specific dog in front of the door.he project consists in making a dog flap. The goal is to detect the presence of a specific dog in front of the doorhe project consists in making a dog flap. The goal is to detect the presence of a specific dog in front of the doorhe project consists in making a dog flap. The goal is to detect the presence of a specific dog in front of the doorhe project consists in making a dog flap. The goal is to detect the presence of a specific dog in front of the door.
</p>
...
<p align="justify">
• The pins corresponding to the actuator power supplies are connected to the Arduino power pins and you can wire the buzzer to the pin 9 and the servomotor to the pin 10. Then Wire the Arduino to the raspberry pi using the USB cable. dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fron
<p align="justify">
•	Using the Arduino IDE, upload the code “ArduinoDogV1.ino” in the Arduino Uno. o the actuator power supplies are connected to the Arduino power pins and you can wire the buzzer to the pin 9 and the servomotor to the pin 10. Then Wire the Arduino to the raspberry pi using the USB cable. dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fo the actuator power supplies are connected to the Arduino power pins and you can wire the buzzer to the pin 9 and the servomotor to the pin 10. Then Wire the Arduino to the raspberry pi using the USB cable. dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in f
<p align="justify">
•	You can wire the lcd display as on the picture below.o the actuator power supplies are connected to the Arduino power pins and you can wire the buzzer to the pin 9 and the servomotor to the pin 10. Then Wire the Arduino to the raspberry pi using the USB cable. dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in fron dog flap. The goal is to detect the presence of a specific dog in f
